...
ActiveRecord::Schema.define(:version => 20150226012855) do
  ...
  create_table "hwm_studios", :force => true do |t|
    ...
    t.integer  "verify_state",        :default => 3, :null => false
  ...
  create_table "hwm_user_account_hwm_products", :force => true do |t|
    t.integer  "hwm_user_account_id"
